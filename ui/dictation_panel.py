...
def build_dictation_panel(host, parent):
    ...
    host.dictation_recent_list.column("word", width=430, minwidth=240, anchor="w", stretch=True)
    host.dictation_recent_list.column("meta", width=220, minwidth=120, anchor="w", stretch=True)
